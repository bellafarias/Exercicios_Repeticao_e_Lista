...
while Validade_nome == False:
    nomeinicial = (input("Digite um nome com mais de 3 carcteres:"))
    if len(nomeinicial) > 3:
        Validade_nome=True
    else :
        print ("Tente novamente, digite um nome com mais de 3 caracteres")

Validade_idade = False
while Validade_idade == False:
    idadeVetor = float(input("Digite sua Idade(que seja maior que 0 e menor que 150):"))
